                        ...
                        <div class="row">
                            ...
                            <!-- Approach -->
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <?php
                                            $result = $mysqli->query("SELECT * from alternatif where id = ".$_GET['id']."");
                                            if(!$result){
                                        ...
                                        <form role="form" method="POST" action="edit-alternatif1.php?id=<?php echo $_GET['id'];?>">
                                            <table class="table table-striped">
                                                <tr>
                                                    <td>Kode Alternatif</td>
                                                    <td><input type="text" value="<?php echo $row["kode"]?>" required readonly class="form-control" name="kode" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Alternatif</td>
                                                    <td><input type="text" value="<?php echo $row["alternatif"]?>" required class="form-control" name="alternatif" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Nomor Polisi</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" value="<?php echo $row["k1"]?>" required class="form-control" name="k1" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Tahun Mobil (K2)</td>
                                                    <td><input type="text" value="<?php echo $row["k2"]?>" required class="form-control" name="k2" /></td>
                                                </tr>
                                                <tr>
                                            ...
                                            <a href="alternatif1.php" type="cancel" class="btn btn-warning">Batal</a>
