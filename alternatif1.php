                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <!-- Approach -->
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                			            <div class="row">
                				            <div class="col-lg-6">
                					            <h6 class="m-0 font-weight-bold text-primary">Data Penilaian Inspeksi Mobil</h6>
                				            </div>
                                            <div class="col-lg-6">
                                                <a href="tambahalternatif1.php" class="btn btn-success btn-icon-split float-right">
                                                    <span class="icon text-white-50">
                                                        <i class="fas fa-plus"></i>
                                                    </span>
                                                    <span class="text">Tambah Data</span>
                                                </a>
                                                <a href="del-all-alternatif1.php" class="btn btn-danger btn-icon-split float-right hapus-all-alternatif" style="margin-right:15px;">
                                                    <span class="icon text-white-50">
                                                        <i class="fas fa-trash"></i>
                                                    </span>
                                                    <span class="text">Clear All Data</span>
                                                </a>
                                                <a href="cetak.php" class="btn btn-primary btn-icon-split float-right" style="margin-right:15px;" target="_blank">
                                                    <span class="icon text-white-50">
							...
							//include 'config.php';
                                            ...
                                            $alternatif = $mysqli->query("SELECT * FROM alternatif ORDER BY kode ASC");
                                            if(!$alternatif){
                                                echo $mysqli->connect_errno." - ".$mysqli->connect_error;
                                                exit();
                                            }
                                        ...
                                        <div class="panel-body table-responsive">
                                            <table id="dataTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <a href="editalternatif1.php?id=<?php echo $row['id'];?>" class="btn btn-success btn-sm btn-icon-split">
                                                                <span class="icon text-white-50"><i class="fas fa-pen"></i></span>
                                                            </a>
														    <a href="del-alternatif1.php?id=<?php echo $row['id'];?>" class="btn btn-danger btn-sm btn-icon-split hapus-alternatif">
