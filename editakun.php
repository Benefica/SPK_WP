                            ...
                            <!-- Approach -->
                                <div class="card shadow mb-4">
                                    ...
                                    <?php
                                        ...
                                        <form role="form" method="POST" action="edit-akun.php?id=<?php echo $_GET['id'];?>">
                                            <table class="table table-striped">
                                                <tr>
                                                    <td>Nama Karyawan</td>
                                                    <td><input type="text" value="<?php echo $row["nama"]?>" required class="form-control" name="nama" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Username</td>
                                                    <td><input type="text" value="<?php echo $row["username"]?>" required class="form-control" name="username" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Password</td>
                                                    <td><input type="text" placeholder="Masukkan Password Baru" required class="form-control" name="password" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Role Akun</td>
                                            ...
                                            <a href="user.php" type="cancel" class="btn btn-warning">Batal</a>
