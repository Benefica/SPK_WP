                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="inspeksi_body.php">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Data Inspeksi Body Mobil</h1>
                        </div>
                            ...
                            <!-- Approach -->
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                			            <div class="row">
                				            <div class="col-lg-6">
                					            <h6 class="m-0 font-weight-bold text-primary">Tambah Data Inspeksi Body</h6>
                				            </div>
                			            </div>
                		            </div>
                                    <div class="card-body">
                                        <form role="form" method="POST" action="tambah-body.php"">
                                            <center>
                                            ...
                                            <center>
                                                <h6 class="m-0 font-weight-bold text-primary">Inspeksi Body Mobil</h6>
                                                <br>
                                            </center>
                                            <table class="table table-striped">
                                                <tr>
                                                ...
                                                <tr>
                                                    <td>Pengecekan Plat Body Mobil</td>
                                                    <td>
                                                        <select name="B1" id="B1" class="form-control" required>
                                                ...
                                                <tr>
                                                    <td>Pengecekan Rangka Mobil</td>
                                                    <td>
                                                        <select name="B2" id="B2" class="form-control" required>
                                                            <option value="" selected="selected" disabled>Silahkan Pilih Hasil Pengecekan</option>
                                                            <option value="1" class="form-control">Tidak Baik</option>
                                                            <option value="2" class="form-control">Kurang Baik</option>
                                                            <option value="3" class="form-control">Cukup Baik</option>
                                                ...
                                                <tr>
                                                    <td>Pengecekan Aksesoris</td>
                                                    <td>
                                                        <select name="B3" id="B3" class="form-control" required>
                                                            <option value="" selected="selected" disabled>Silahkan Pilih Hasil Pengecekan</option>
                                                            <option value="1" class="form-control">Tidak Baik</option>
                                                            <option value="2" class="form-control">Kurang Baik</option>
                                                            <option value="3" class="form-control">Cukup Baik</option>
                                                ...
                                                <tr>
                                                    <td>Pengecekan Kualitas Cat</td>
                                                    <td>
                                                        <select name="B4" id="B4" class="form-control" required>
                                                            <option value="" selected="selected" disabled>Silahkan Pilih Hasil Pengecekan</option>
                                                            <option value="1" class="form-control">Tidak Baik</option>
                                                            <option value="2" class="form-control">Kurang Baik</option>
                                                            <option value="3" class="form-control">Cukup Baik</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="B5" id="B5" class="form-control" required>
                                                            <option value="" selected="selected" disabled>Silahkan Pilih Hasil Pengecekan</option>
                                                            <option value="1" class="form-control">Tidak Baik</option>
                                                            <option value="2" class="form-control">Kurang Baik</option>
                                                            <option value="3" class="form-control">Cukup Baik</option>
