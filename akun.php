                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                			            <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <a href="user.php" class="btn btn-primary btn-icon-split float-right">
                                                    <span class="icon text-white-50">
                                                        <i class="fas fa-search"></i>
                                                    </span>
                                                    <span class="text">List Data User</span>
                                                </a>
                                            </div>
                			            </div>
                		            </div>
                                    <div class="card-body">
                                        ...
                                        <form role="form" method="POST" action="tambah-akun.php">
                                            <table class="table table-striped">
                                                <tr>
                                                    <td>Nama Karyawan</td>
                                                    <td><input type="text" placeholder="Masukkan Nama Karyawan" required class="form-control" name="nama" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Username</td>
                                                    <td><input type="text" placeholder="Buat Username" required class="form-control" name="username" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Password</td>
                                                    <td><input type="text" placeholder="Buat Password" required class="form-control" name="password" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Role Akun</td>
                                                    <td><select name="role" id="role" class="form-control" required>
                                                        <option value="" selected="selected" disabled>Pilih Role Akun</option>
                                                        <option value="admin">ADMIN</option>
                                                        <option value="sales">SALES</option>
                                                    </select></td>
                                                </tr>
                                            </table>
                                            <a href="akun.php" type="cancel" class="btn btn-danger">Batal</a>
