                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Data Inspeksi Interior</h1>
                        </div>
                            ...
                            <!-- Approach -->
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                			            <div class="row">
                				            <div class="col-lg-6">
                					            <h6 class="m-0 font-weight-bold text-primary">Ubah Data Inspeksi Interior</h6>
                				            </div>
                			            </div>
                		            </div>
                                    <div class="card-body">
                                        <?php
                                            $result = $mysqli->query("SELECT * from interior where id = ".$_GET['id']."");
                                            if(!$result){
                                                echo $mysqli->connect_errno." - ".$mysqli->connect_error;
                                                exit();
                                            }
                                        ...
                                        ?>
                                        <form role="form" method="POST" action="edit-interior.php?id=<?php echo $_GET['id'];?>">
                                            <center>
                                            ...
                                            <a href="inspeksi_interior.php" type="cancel" class="btn btn-warning">Batal</a>
