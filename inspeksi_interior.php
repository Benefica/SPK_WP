                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Inspeksi Interior Mobil</h1>
                        </div>
                            ...
                            <!-- Approach -->
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                			            <div class="row">
                				            <div class="col-lg-6">
                					            <h6 class="m-0 font-weight-bold text-primary">Data Inspeksi Interior Mobil</h6>
                				            </div>
                                            <div class="col-lg-6">
                                                <a href="tambahinterior.php" class="btn btn-success btn-icon-split float-right">
                                            ...
                                            <table class="table table-striped table-bordered" id="dataTable"  width="100%" cellspacing="0">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>AC Mobil</th>
                                                        <th>Perseneling</th>
                                                        <th>Aksesoris Dalam</th>
                                                        <th>Jok Dan Panel Interior</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <a href="editinterior.php?id=<?php echo $row['id'];?>" class="btn btn-success btn-sm btn-icon-split">
                                                                <span class="icon text-white-50"><i class="fas fa-pen"></i></span>
                                                            </a>
														    <a href="del-interior.php?id=<?php echo $row['id'];?>" class="btn btn-danger btn-sm btn-icon-split hapus-interior">
