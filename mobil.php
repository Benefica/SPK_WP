                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                			            <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <a href="tambahmobil.php" class="btn btn-success btn-icon-split float-right">
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        while ($row = $mobil->fetch_assoc()) {
                                                            ...
                                                            echo '<td>'.$row["wiraniaga"].'</td>';
                                                            echo '<td><!--a href="#"><i class="fa fa-search"></i></a-->';
                                                    ?>
                                                            <a href="editmobil.php?id=<?php echo $row['id'];?>" class="btn btn-success btn-sm btn-icon-split">
                                                                <span class="icon text-white-50"><i class="fas fa-pen"></i></span>
                                                            </a>
														    <a href="del-mobil.php?id=<?php echo $row['id'];?>" class="btn btn-danger btn-sm btn-icon-split hapus-mobil">
