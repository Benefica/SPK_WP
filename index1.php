                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <!-- Card Data Mobil -->
                            <?php
                                $mobil = $mysqli->query("SELECT COUNT(*) AS jumlah FROM mobil");
                                ...
                                if ($mobil->num_rows > 0) {
                                    $row = $mobil->fetch_assoc();
                                    $jumlahDataMobil = $row["jumlah"];
                            ?>
                                ...
                                <div class="card border-left-primary shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Jumlah Data Mobil</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlahDataMobil ?></div>
                                            </div>
                                            <div class="col-auto">
                            ...
                            <!-- Data Inspeksi -->
                            <?php
                                $inspeksi = $mysqli->query("SELECT COUNT(*) AS jumlah FROM alternatif");
                                ...
                                if ($inspeksi->num_rows > 0) {
                                    $row = $inspeksi->fetch_assoc();
                                    $jumlahDataInspeksi = $row["jumlah"];
                            ?>
                                ...
                                <div class="col-xl-3 col-md-6 mb-4">
                                    <div class="card border-left-danger shadow h-100 py-2">
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Jumlah Data Inspeksi</div>
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlahDataInspeksi; ?></div>
                                                </div>
                                                <div class="col-auto">
                            ...
                            <!-- Card Data Admin -->
                            <?php
                                $admin = $mysqli->query("SELECT COUNT(*) AS jumlah FROM user WHERE role='admin'");
                            ...
                            <!-- Card Data Sales -->
                            <?php
                                $sales = $mysqli->query("SELECT COUNT(*) AS jumlah FROM user WHERE role='sales'");
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card border-left-warning shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Jumlah Sales</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlahSales ?></div>
                                            </div>
                                            <div class="col-auto">
                        ...
                        <div class="row">
                            ...
                            <!-- Approach -->
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <p><b>Aplikasi Sistem Pendukung Keputusan menggunakan Metode Weight Product - Inspeksi Kelayakan Mobil Bekas</b></p>
