...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            <!-- Sidebar -->
            <ul style="background-color:#CC0000;" class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                <!-- Sidebar - Brand -->
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                			            <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <a href="tambahmobil1.php" class="btn btn-success btn-icon-split float-right">
