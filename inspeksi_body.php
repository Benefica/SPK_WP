                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                			            <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <a href="tambahbody.php" class="btn btn-success btn-icon-split float-right">
                                        ...
                                        <div class="panel-body table-responsive">
                                            <table class="table table-striped table-bordered" id="dataTable"  width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <a href="editbody.php?id=<?php echo $row['id'];?>" class="btn btn-success btn-sm btn-icon-split">
                                                                <span class="icon text-white-50"><i class="fas fa-pen"></i></span>
                                                            </a>
														    <a href="del-body.php?id=<?php echo $row['id'];?>" class="btn btn-danger btn-sm btn-icon-split hapus-body">
