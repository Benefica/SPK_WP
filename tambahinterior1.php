                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="inspeksi_interior1.php">
                                <i class="fas fa-car"></i>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Data Inspeksi Interior Mobil</h1>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <?php
                                    $interior = $mysqli->query("SELECT * from interior");
                                    if(!$interior){
                                        echo $mysqli->connect_errno." - ".$mysqli->connect_error;
                                        exit();
                                    }
                                    $i=0;
											while ($row = $interior->fetch_assoc()) {
												@$a[$i] = $row["kode"];
												$i++;
											}
                            ...
                            <!-- Approach -->
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                			            <div class="row">
                				            <div class="col-lg-6">
                					            <h6 class="m-0 font-weight-bold text-primary">Tambah Data Inspeksi Interior</h6>
                				            </div>
                			            </div>
                		            </div>
                                    <div class="card-body">
                                        <form role="form" method="POST" action="tambah-interior1.php"">
                                            <center>
                                            ...
                                            <table class="table table-striped">
                                                <tr>
                                                    <td>Pilih Mobil</td>
                                                            <td><select name="mobil" id="mobil" class="form-control" data-control="select2" onchange="detail()" required>
                                                                <option value="" selected="selected">Silahkan Pilih Mobil</option>
                                                                <?php
                                                ...
                                                <tr>
                                                    <td>Nama Mobil</td>
                                                    <td><input type="text" placeholder="Pilih Data Mobil Diatas" required readonly class="form-control" name="nama_mobil" id="nama_mobil"/></td>
                                                </tr>
                                                <tr>
                                                    <td>Nomor Polisi</td>
                                            ...
                                            <center>
                                                <h6 class="m-0 font-weight-bold text-primary">Inspeksi Interior Mobil</h6>
                                                <br>
                                            </center>
                                            <table class="table table-striped">
                                                <tr>
                                                ...
                                                <tr>
                                                    <td>Pengecekan Kondisi Stir Mobil</td>
                                                    <td>
                                                        <select name="I1" id="I1" class="form-control" required>
                                                            <option value="" selected="selected" disabled>Silahkan Pilih Hasil Pengecekan</option>
                                                            <option value="1" class="form-control">Tidak Baik</option>
                                                            <option value="2" class="form-control">Kurang Baik</option>
                                                            <option value="3" class="form-control">Cukup Baik</option>
                                                            <option value="4" class="form-control">Baik</option>
                                                            <option value="5" class="form-control">Sangat Baik</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Pengecekan AC Mobil</td>
                                                    <td>
                                                        <select name="I2" id="I2" class="form-control" required>
                                                            <option value="" selected="selected" disabled>Silahkan Pilih Hasil Pengecekan</option>
                                                            <option value="1" class="form-control">Tidak Baik</option>
                                                            <option value="2" class="form-control">Kurang Baik</option>
                                                            <option value="3" class="form-control">Cukup Baik</option>
                                                ...
                                                <tr>
                                                    <td>Pengecekan Perseneling</td>
                                                    <td>
                                                        <select name="I3" id="I3" class="form-control" required>
                                                            <option value="" selected="selected" disabled>Silahkan Pilih Hasil Pengecekan</option>
                                                            <option value="1" class="form-control">Tidak Baik</option>
                                                            <option value="2" class="form-control">Kurang Baik</option>
                                                            <option value="3" class="form-control">Cukup Baik</option>
                                                ...
                                                <tr>
                                                    <td>Pengecekan Aksesoris Dalam</td>
                                                    <td>
                                                        <select name="I4" id="I4" class="form-control" required>
                                                            <option value="" selected="selected" disabled>Silahkan Pilih Hasil Pengecekan</option>
                                                            <option value="1" class="form-control">Tidak Baik</option>
                                                            <option value="2" class="form-control">Kurang Baik</option>
                                                            <option value="3" class="form-control">Cukup Baik</option>
                                                ...
                                                <tr>
                                                    <td>Pengecekan Jok dan Panel Interior</td>
                                                    <td>
                                                        <select name="I5" id="I5" class="form-control" required>
                                                            <option value="" selected="selected" disabled>Silahkan Pilih Hasil Pengecekan</option>
                                                            <option value="1" class="form-control">Tidak Baik</option>
                                                            <option value="2" class="form-control">Kurang Baik</option>
                                                            <option value="3" class="form-control">Cukup Baik</option>
                                            ...
                                            <a href="inspeksi_mesin.php" type="cancel" class="btn btn-danger">Batal</a>
