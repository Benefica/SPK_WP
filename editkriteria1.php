                            ...
                            <!-- Approach -->
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                			            <div class="row">
                				            <div class="col-lg-6">
                					            <h6 class="m-0 font-weight-bold text-primary">Ubah Data Kriteria</h6>
                				            </div>
                			            </div>
                		            </div>
                                    <div class="card-body">
                                        ...
                                        <form role="form" method="POST" action="edit-kriteria1.php?id=<?php echo $_GET['id'];?>">
                                            <table class="table table-striped">
                                                <tr>
                                                    <td>Nama Kriteria</td>
                                                    <td><input type="text" value="<?php echo $row["kriteria"]?>" required class="form-control" name="kriteria" /></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="kepentingan" id="kepentingan" class="form-control" required>
                                                            ...
                                                            <option value="1" class="form-control">Tidak Penting</option>
                                                            <option value="2" class="form-control">Kurang Penting</option>
                                                            <option value="3" class="form-control">Cukup Penting</option>
                                                            <option value="4" class="form-control">Penting</option>
                                                            <option value="5" class="form-control">Sangat Penting</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="cost_benefit" id="cost_benefit" class="form-control" required>
                                                            <option value="" selected="selected" disabled>Silahkan Pilih Jenis Kriteria</option>
                                                            <option value="cost" class="form-control">COST</option>
                                                            <option value="benefit" class="form-control">BENEFIT</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                            </table>
                                            <button type="reset" class="btn btn-info">Reset</button>
                                            <a href="kriteria1.php" type="cancel" class="btn btn-warning">Batal</a>
