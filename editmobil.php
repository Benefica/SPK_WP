                            ...
                            <!-- Approach -->
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                			            <div class="row">
                				            <div class="col-lg-6">
                					            <h6 class="m-0 font-weight-bold text-primary">Ubah Data Mobil</h6>
                				            </div>
                			            </div>
                		            </div>
                                    <div class="card-body">
                                        ...
                                        <?php
                                            $result = $mysqli->query("SELECT * from mobil where id = ".$_GET['id']."");
                                            if(!$result){
                                        ...
                                        <form role="form" method="POST" action="edit-mobil.php?id=<?php echo $_GET['id'];?>">
                                            <table class="table table-striped">
                                                <tr>
                                                    <td>Nama Mobil</td>
                                                    <td><input type="text" value="<?php echo $row["nama_mobil"]?>" required class="form-control" name="nama_mobil" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Nomor Polisi</td>
                                                    <td><input type="text" value="<?php echo $row["nopol"]?>" required class="form-control" name="nopol" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Harga Mobil</td>
                                                    <td><input type="text" value="<?php echo $row["harga"]?>" required class="form-control" name="harga" pattern="[0-9]+" title="Harga harus berupa angka" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Tahun Mobil</td>
                                                    <td><input type="text" value="<?php echo $row["tahun"]?>" required class="form-control" name="tahun" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Warna Mobil</td>
                                                    <td><input type="text" value="<?php echo $row["warna"]?>" required class="form-control" name="warna" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Penjual</td>
                                                    <td><input type="text" value="<?php echo $row["wiraniaga"]?>" required class="form-control" name="wiraniaga" /></td>
                                                </tr>
                                            </table>
                                            <button type="reset" class="btn btn-info">Reset</button>
                                            <a href="mobil.php" type="cancel" class="btn btn-warning">Batal</a>
