                                        ...
                                        <div class="panel-body table-responsive">
                                            <table class="table table-striped table-bordered" id="dataTable"  width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <a href="editakun.php?id=<?php echo $row['id'];?>" class="btn btn-success btn-sm btn-icon-split">
                                                                <span class="icon text-white-50"><i class="fas fa-pen"></i></span>
                                                            </a>
														    <a href="del-akun.php?id=<?php echo $row['id'];?>" class="btn btn-danger btn-sm btn-icon-split hapus-user">
